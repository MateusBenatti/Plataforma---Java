...
public class World {
			...
			for(int xx = 0; xx < map.getWidth(); xx++){
				for(int yy = 0; yy < map.getHeight(); yy++){
					...
					if(pixelAtual == 0xFF000000) {
						...
						//Para deixar os tiles inteligentes
						//Para no chao nao pegar sempre o tile da parte da grama, o q estiver em baixo
						//pegar o tile da terra de fundo
						...
						}//Se for por mais um tem q ser outro if
						if(yy-2 >= 0 && pixels[xx + (yy-2)  * map.getWidth()] == 0xFFffffff) {
	...
	public static void restartGame(){
		//TODO: Aplicar metodo para reiniciar o jogo corretemente
		return;
	}
